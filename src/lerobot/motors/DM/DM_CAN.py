...
class MotorControl:
    ...
    #默认VMAX(rad / s)
    #默认TMAX(Nm)
    #Limit_Param第一列是达妙官方根据电机编码器精度、通信协议适配的固定映射值，绝对不能改！限速只需要改第二列
    #我也不知道这个是啥参数，但是修改之后导致数值不准，转一圈不是2pi了，我怀疑和减速比有关
    Limit_Param = [
        [12.5,    0.1,  10],  # DM4310
        [12.5,    0.1,  10],  # DM4310_48
        [12.5,    0.1,  28],  # DM4340
        [12.5,    0.1,  28],  # DM4340_48
        [12.5,    0.1,  20],  # DM6006
        [12.5,    0.1,  40],  # DM8006
        [12.5,    0.1,  54],  # DM8009
        [12.5,    0.1, 200],  # DM10010L
        [12.5,    0.1, 200],  # DM10010
        [12.5,    0.1,   1],  # DMH3510
        [12.5,    0.1,  10],  # DMG6215
        [12.5,    0.1,  10],  # DMH6220
        [12.5 ,   0.1, 12],   # DMJH11
        [12.566,  0.1, 120],  # DM6248P
        [12.566,  0.1,   5],  # DM3507
    ]
    ...
    def controlMIT(self, DM_Motor, kp: float, kd: float, q: float, dq: float, tau: float):
        ...
        # 可选：接收响应，但增加异常处理避免通信错误
        try:
            self.recv()
        except Exception as e:
            print(f"Error receiving response in controlMIT: {e}")
            pass  # 忽略接收错误，不影响控制命令发送
    ...
    def control_Pos_Vel(self, Motor, P_desired: float, V_desired: float):
        ...
        try:
            ...
            print(f"Error receiving response in control_Pos_Vel: {e}")
            pass
    ...
    def control_Vel(self, Motor, Vel_desired):
        ...
        try:
            ...
            print(f"Error receiving response in control_Vel: {e}")
            pass
    ...
    def control_pos_force(self, Motor, Pos_des: float, Vel_des, i_des):
        ...
        try:
            ...
            print(f"Error receiving response in control_pos_force: {e}")
            pass
    ...
    def control_Pos_Vel_CSP(self, Motor, P_desired: float, V_desired: float):#谐波JH11电机有这个模式
        ...
        try:
            ...
            print(f"Error receiving response in control_Pos_Vel_CSP: {e}")
            pass
    ...
    def control_Vel_CSP(self, Motor, Vel_desired):#谐波JH11电机有这个模式
        ...
        try:
            ...
            print(f"Error receiving response in control_Vel_CSP: {e}")
            pass
    ...
    def enable(self, Motor):
        ...
        try:
            ...
            print(f"Error receiving response in enable: {e}")
            pass
    ...
    def enable_old(self, Motor ,ControlMode):
        ...
        try:
            ...
            print(f"Error receiving response in enable_old: {e}")
            pass
    ...
    def set_zero_position(self, Motor):
        ...
        try:
            ...
            print(f"Error receiving response in set_zero_position: {e}")
            pass
    ...
    def recv(self):
        ...
        try:
            ...
            print(f"Serial read error in recv(): {e}")
            return
        # print(data_recv)
        if not data_recv:
            # 没有收到数据，跳过处理
    ...
    def refresh_motor_status(self,Motor):
        ...
        try:
            ...
            print(f"Error receiving response in refresh_motor_status: {e}")
            pass
